...
/***/ "./src/kaleflower/includes/components/LayoutView/LayoutView_files/src/includes/PanelsInfo.js":
/*!***************************************************************************************************!*\
  !*** ./src/kaleflower/includes/components/LayoutView/LayoutView_files/src/includes/PanelsInfo.js ***!
  \***************************************************************************************************/
...
/* harmony export */   PanelsInfo: () => (/* binding */ PanelsInfo)
/* harmony export */ });
...
var _PanelsInfo_brand = /*#__PURE__*/new WeakSet();
var PanelsInfo = /*#__PURE__*/function () {
  /**
   * Constructor
   */
  function PanelsInfo(_$2) {
    _classCallCheck(this, PanelsInfo);
    _classPrivateMethodInitSpec(this, _PanelsInfo_brand);
    _classPrivateFieldInitSpec(this, _$, void 0);
    _classPrivateFieldSet(_$, this, _$2);
  }
  return _createClass(PanelsInfo, [{
    key: "collectInstance",
    value:
    /**
     * Get the instance
    ...
    function collectInstance() {
      var _this = this;
      var $ = _classPrivateFieldGet(_$, this);
      var rtn = [];
      var layers = [];
      $("[data-kaleflower-instance-id]").each(function (index, elm) {
        ...
        var data = {
          ...
          'parent': {
            ...
            'isLayer': _assertClassBrand(_PanelsInfo_brand, _this, _isLayer).call(_this, $parent.get(0))
          },
          ...
          'isLayer': _assertClassBrand(_PanelsInfo_brand, _this, _isLayer).call(_this, elm),
        ...
        if (data.isLayer) {
          for (var i = layers.length - 1; i >= 0; i--) {
            var husCurrentLayer = $this.closest("[data-kaleflower-instance-id=\"".concat(layers[i], "\"]")).length;
            if (husCurrentLayer) {
          ...
          for (var _i = layers.length - 1; _i >= 0; _i--) {
            var _husCurrentLayer = $this.closest("[data-kaleflower-instance-id=\"".concat(layers[_i], "\"]")).length;
            if (_husCurrentLayer) {
              data.currentLayer = layers[_i];
              break;
            }
          }
        }
...
function _isLayer(elm) {
  var $ = _classPrivateFieldGet(_$, this);
  var $elm = $(elm);
  var position = $elm.css('position');
  var top = $elm.css('top');
  var right = $elm.css('right');
  var bottom = $elm.css('bottom');
...
"use strict";
/*!***********************************************************************************************!*\
  !*** ./src/kaleflower/includes/components/LayoutView/LayoutView_files/src/PreviewContents.js ***!
  \***********************************************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _includes_PanelsInfo_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./includes/PanelsInfo.js */ "./src/kaleflower/includes/components/LayoutView/LayoutView_files/src/includes/PanelsInfo.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }


(function () {
  var panelsInfo = new _includes_PanelsInfo_js__WEBPACK_IMPORTED_MODULE_1__.PanelsInfo((jquery__WEBPACK_IMPORTED_MODULE_0___default()));
  var $iframeWindowDocument = jquery__WEBPACK_IMPORTED_MODULE_0___default()(window.document);
  var _origin;
  ...
  function resetPreviewDomElements() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('body *').attr({
      'tabindex': '-1'
    }).css({
      'outline': 'none'
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('img').off("load").on("load", function () {
      var instances = panelsInfo.collectInstance();
  ...
  window.addEventListener('message', function (event) {
    ...
    if (data.api == 'ping') {
      ...
      var scriptElement = document.querySelector("".concat(data.options.scriptReceiverSelector || '[data-kaleflower-receive-message="yes"]'));
      if (scriptElement) {
      ...
      $iframeWindowDocument.find(data.options.contentsAreaSelector).html('...').each(function () {
        var $this = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-kaleflower-assets-placeholser]').remove();
      var styleElement = document.createElement('style');
      styleElement.setAttribute('data-kaleflower-assets-placeholser', true);
      styleElement.innerHTML = data.options.css;
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('head').append(styleElement);
      var _scriptElement = document.createElement('script');
      _scriptElement.setAttribute('data-kaleflower-assets-placeholser', true);
      _scriptElement.innerHTML = data.options.js;
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').append(_scriptElement);
      ...
      var rtn = {};
      data.options.instances.forEach(function (instanceId) {
        var $instance = $iframeWindowDocument.find("[data-kaleflower-instance-id=\"".concat(instanceId, "\"]"));
        rtn[instanceId] = {
          'instanceId': instanceId,
      ...
      var bowls = [];
      $iframeWindowDocument.find(data.options.contentsAreaSelector).each(function () {
        var $this = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
        var bowlName = $this.attr(data.options.contentsContainerNameBy);
        if (_typeof(bowlName) !== _typeof('') || !bowlName.length) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop(data.options.scrollTop);
      return;
    } else {
      callbackMessage(data.callback, {
        "result": false,
